...
IN_PATH = Path("data/raw/2026-01-11.json")
OUT_PATH = Path("data/private_text/clue_answer_pairs_2026-01-11.csv")
...
if __name__ == "__main__":
    ...
    rows = extract_clue_answer_rows(puzzle_json, date_str="2026-01-11")
    print(f"Extracted {len(rows)} clue-answer rows")
